...
{fr:"retirer",en:"to withdraw",phon:"*ruh-tee-RAY*",def:"Prendre de l'argent sur son compte.",ex:"Retirer de l'argent au distributeur.",level:11,cat:"admin"},
{fr:"faire le plein",en:"to fill up (gas)",phon:"*fair luh PLAN*",def:"Remplir le réservoir d'essence.",ex:"Je fais le plein avant le voyage.",level:11,cat:"voiture"},
{fr:"l'essence",en:"gasoline",phon:"*lay-SONSS*",def:"Carburant pour moteur essence.",ex:"L'essence est chère en ce moment.",level:11,cat:"voiture"},
{fr:"en panne",en:"broken down",phon:"*on PAN*",def:"Qui ne fonctionne plus.",ex:"Ma voiture est en panne.",level:11,cat:"voiture"},
{fr:"une station-service",en:"gas station",phon:"*sta-SYON ser-VEES*",def:"Lieu où on achète de l'essence.",ex:"Arrêt à la station-service.",level:11,cat:"voiture"},
{fr:"un colis",en:"package",phon:"*uh ko-LEE*",def:"Objet envoyé par la poste.",ex:"Recevoir un colis.",level:11,cat:"poste"},
{fr:"envoyer",en:"to send",phon:"*on-vwa-YAY*",def:"Faire parvenir quelque chose à quelqu'un.",ex:"Envoyer une lettre.",level:11,cat:"poste"},
{fr:"recommandé",en:"registered (mail)",phon:"*ruh-ko-mon-DAY*",def:"Envoi avec accusé de réception.",ex:"Envoyer en recommandé.",level:11,cat:"poste"},
